...
class GaussianDiffusion(nn.Module):
    ...
    def training_losses(self, model, z1, x_start):
        ...
        mse = self.mean_flat((z1 - model_output) ** 2)  # 318
    ...
    def training_losses2(self, model, x_start):
        ...
        print(x_start.shape,x_t.shape,ts.shape)
