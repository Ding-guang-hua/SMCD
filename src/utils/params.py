...
def imdb_params():
    ...
    # The parameters of train
    parser.add_argument('--epochs', type=int, default=950)#1150
    ...
    parser.add_argument('--mp_lam', type=float, default=0.3)
    ...
    parser.add_argument('--ic_lam', type=float, default=0.4)
